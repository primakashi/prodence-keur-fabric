...
const newRequest = require('../../organization/prodence/pembayaran/issue');
const getOneRequest = require('../../organization/prodence/pembayaran/getpembayaran');
const updateDataRequest = require('../../organization/prodence/pembayaran/update');
...
exports.getRequest = (req, res) => { // eslint-disable-line
    try {
        ...
        if (valid) {
            getOneRequest.getPembayaran(req.body, (err,data)=>{
                if (err) {
                    res.status(400);
                    res.send({
                        err: true,
...
exports.createRequest = (req, res) => { // eslint-disable-line
    try {
        ...
        if (valid) {
            newRequest.createPembayaran(req.body, (err,data)=>{
                if (err) {
                    res.status(400);
                    res.send({
                        err: true,
...
exports.updateRequest = (req, res) => { // eslint-disable-line
    try {
        ...
        if (valid) {
            updateDataRequest.updatePembayaran(req.body, (err,data)=>{
                if (err) {
                    res.status(400);
                    res.send({
                        err: true,
...
exports.deleteRequest = (req, res) => { // eslint-disable-line
    try {
        ...
        if (valid) {
            deleteDataRequest.deletePembayaran(req.body, (err,data)=>{
                if (err) {
                    res.status(400);
                    res.send({
                        err: true,
