...
class Sistem_remContract extends Contract {
    ...
    async create(ctx, no_pemeriksaan, no_kendaraan, pedal_rem, speling_pedal, keobocran_kelemahan, sambungan_tuas_kabel, pipa_selang, silinder_katup, terombol_cakram, porode, sistem_vakum_fungsi, sistem_vakum_kebocoran, sistem_vakum_pengisian, sistem_vakum_penggerak_rem, sistem_vakum_pengisian_kereta_gandengan, sistem_vakum_tekanan_angin, rem_parkir_tuas_tangan, rem_parkir_speling_tuas, rem_parkir_kebocoran, rem_parkir_sambungan_tuas_kabel, sistem_rem_emisi_gas_buang, efisiensi_rem_utama, efisiensi_rem_perbedaan_depan, efisiensi_rem_perbedaan_belakang, efisiensi_rem_parkir, status) {
        let sistem_rem = Sistem_rem.createInstance(no_pemeriksaan, no_kendaraan, pedal_rem, speling_pedal, keobocran_kelemahan, sambungan_tuas_kabel, pipa_selang, silinder_katup, terombol_cakram, porode, sistem_vakum_fungsi, sistem_vakum_kebocoran, sistem_vakum_pengisian, sistem_vakum_penggerak_rem, sistem_vakum_pengisian_kereta_gandengan, sistem_vakum_tekanan_angin, rem_parkir_tuas_tangan, rem_parkir_speling_tuas, rem_parkir_kebocoran, rem_parkir_sambungan_tuas_kabel, sistem_rem_emisi_gas_buang, efisiensi_rem_utama, efisiensi_rem_perbedaan_depan, efisiensi_rem_perbedaan_belakang, efisiensi_rem_parkir, status);
