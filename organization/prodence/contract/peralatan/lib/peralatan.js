...
class Peralatan extends State {
    ...
    setPemeriksaanPeralatan(newNoRangka, newPelatPabrik, newPelatNomor, newTulisan, newPenghapusKacaDepan, newKlakson, newKacaSpion, newPandangan, newKacaPenawarSinar, newAlatPengendalian, newLampuIndikasi, newSpeedometer, newPerlengkapan, newStatus) {
    ...
    static createInstance(no_pemeriksaan, no_kendaraan, no_rangka, pelat_pabrik_pembuatnya, pelat_nomor, tulisan, penghapus_kaca_dapan, klakson, kaca_spion, pandangan_ke_depan, kaca_penawar_sinar, alat_pengendalian, lampu_indikasi, speedometer, perlangkapan, status) {
        return new Peralatan({ no_pemeriksaan, no_kendaraan,no_rangka, pelat_pabrik_pembuatnya, pelat_nomor, tulisan, penghapus_kaca_dapan, klakson, kaca_spion, pandangan_ke_depan, kaca_penawar_sinar, alat_pengendalian, lampu_indikasi, speedometer, perlangkapan, status});
    }
