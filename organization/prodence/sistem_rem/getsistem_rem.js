...
// PosSistem_rem.getSistem_rem = (data, result) =>{
...
async function main() {
    ...
    try {
        ...
        const issueResponse = await contract.submitTransaction('getSistem_rem', '1314325', 'AD3435FE', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'false', 'baik', 'baik', 'lulus');
