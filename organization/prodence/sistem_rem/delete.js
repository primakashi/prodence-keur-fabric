...
// PosSistem_rem.deleteSistem_rem = (data, result) =>{
...
async function main() {
    ...
    try {
        ...
        const issueResponse = await contract.submitTransaction('delete','1314325', 'AD3435FE', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'true', 'baik', 'baik', 'tidak' );
