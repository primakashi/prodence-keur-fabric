...
async function main() {
    ...
    try {
        ...
        const issueResponse = await contract.submitTransaction('update', '1314325', 'AD3435FE', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'false', 'baik', 'baik', 'lulus');
