...
PosTireRim.updateTireRim = (data, result) =>{
    ...
    async function main() {
        ...
        try {
            ...
            const issueResponse = await contract.submitTransaction('update', data.no_pemeriksaan, data.no_kendaraan, data.ukuran_dan_jenis_ban, data.keadaan_ban, data.kedalaman_kembang_ban, data.ukuran_dan_jenis_pelek, data.keadaan_pelek, data.penguatan_ban, data.status);
