...
PosTireRim.updateTireRim = (data, result) =>{
    ...
    async function main() {
        ...
        try {
            ...
            const issueResponse = await contract.submitTransaction('update', data.no_pemeriksaan, data.no_kendaraan, data.ukuran_dan_jenis_ban.toString(), data.keadaan_ban.toString(), data.kedalaman_kembang_ban.toString(), data.ukuran_dan_jenis_pelek.toString(), data.keadaan_pelek.toString(), data.penguatan_ban.toString(), data.status);
