...
PosLain_lain.updateLain_lain = (data, result) =>{
    ...
    async function main() {
        ...
        try {
            ...
            console.log(`${lain_lain.no_pemeriksaan} kendaraan : ${lain_lain.no_kendaraan} successfully issued for value ${peralatan.no_pemeriksaan}`);
