...
// PosMesin_transmisi.deleteMesin_transmisi = (data, result) =>{
    ...
    async function main() {
        ...
        try {
            ...
            const issueResponse = await contract.submitTransaction('delete','123415', 'AD2345EV', 'baik', 'baik', 'baik', 'baik', 'baik', 'baik', 'lulus');
