...
PosUji_kelayakan.updateUji_kelayakan = (data, result) =>{
    ...
    async function main() {
        ...
        try {
            ...
            const issueResponse = await contract.submitTransaction('update', data.no_pemeriksaan, data.no_kendaraan, data.side_slip.toString(), data.rem_utama.toString(), data.rem_parkir.toString(), data.gaya_rem_s11.toString(), data.gaya_rem_s12.toString(), data.gaya_rem_s21.toString(), data.gaya_rem_s22.toString(), data.gaya_rem_s31.toString(), data.gaya_rem_s32.toString(), data.gaya_rem_s41.toString(), data.gaya_rem_s42.toString(), data.speedometer.toString(), data.notes, data.status);
