...
// PosUji_kelayakan.deleteUji_kelayakan = (data, result) =>{
...
async function main() {
    ...
    try {
        ...
        const issueResponse = await contract.submitTransaction('delete', '1231435', 'AD5846EG', '565', '878', '345', '898', '300', '500', '789', '246', '546', '346', '256', 'baik', 'baik', 'tidak');
