...
// PosSistem_kemudi.getSistem_kemudi = (data, result) =>{
...
async function main() {
    ...
    try {
        ...
        const issueResponse = await contract.submitTransaction('get', '2131141', 'D4354XE', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'apa aja', 'verified' );
